...
차량 등록의 자동 제원 카탈로그는 연식·차명·동력원·세부 구동 사양·트림이 모두 일치할 때만 적용됩니다. 현재 승인 범위는 [2027 기아 EV6](https://www.kia.com/kr/vehicles/ev6/price)(스탠다드 2WD 63.0kWh, 롱레인지 2WD·4WD 84.0kWh), [2025 현대 코나 Electric](https://www.hyundai.com/contents/repn-car/catalog/kona-electric-2025-price.pdf)(스탠다드 48.6kWh, 롱레인지 64.8kWh), [2027 제네시스 ELECTRIFIED GV70](https://www.genesis.com/kr/ko/models/electrified-gv70)(듀얼모터 AWD 84.0kWh)입니다. 자동 매핑이 없는 전기차는 트림과 세부 구동 사양 외에 사용자가 확인한 배터리 용량을 입력해야 하며, 이를 공식 자동 제원처럼 표시하지 않습니다. 출처는 각 프로필에 확인일과 함께 저장합니다.
