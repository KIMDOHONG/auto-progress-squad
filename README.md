...
5. **생성 품질 후보 개선**: 넥쏘·ELECTRIFIED GV70 실문서 3문항 탐색에서 1.5B 후보가 1/3만 통과했으므로, 더 큰 지시 모델 또는 추출형 요약 후보를 같은 출처 격리 조건과 확장 질문 세트로 비교
